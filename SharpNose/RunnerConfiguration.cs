...
namespace SharpNose
{
    ...
    /// </summary>
    public partial class RunnerConfiguration : ConfigurationElement
    {
...
namespace SharpNose
{
    ...
    public partial class RunnerConfigurations : ConfigurationElementCollection
    {
        #region Constants
        ...
        {
            return ((RunnerConfiguration) (base.BaseGet(((object) (name)))));
        }
...
namespace SharpNose
{
    ...
    /// </summary>
    public partial class Plugins : ConfigurationSection
    {
